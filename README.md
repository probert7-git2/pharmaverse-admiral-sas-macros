...
1. Review the docs/ folder for conceptual background and dataset-specific notes.
2. Explore the macros/ directory to see the AI-generated SAS implementations.
3. Run the programs in programs/ on SAS ODA to generate ADaM datasets.
4. Examine validation/ outputs to understand how the SAS results compare to Pharmaverse ADaM.
